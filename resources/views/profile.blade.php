                ...
                <article>
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <h4><strong><a href="{{url('flight-detail')}}">{{ $key->flight_to->airline->airline_name }} (<?php if($key->fb_fl_return_id > 0) echo"Return"; ?> )</a></strong></h4>
                                    <div class="row">
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-3 text-right">
                                            ...
                                            <form method="POST" action="{{url('detail-book-profile')}}">
                                              ...
                                              <button class="btn btn-link" type="submit"> See Detail </button>  
                                                ...
                                                <a  class="btn btn-danger" onclick="return confirm('Xin lỗi! Chức năng chưa hoàn thiện!');">Cancel Ticket</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
