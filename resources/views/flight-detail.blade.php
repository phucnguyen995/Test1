    ...
    <main>
        <div class="container">
            <section>
               ...
               <h2>Chi tiết chuyến bay lượt đi : {{$data['get_city_from']->city_name }} ({{$data['get_city_from']->city_code}}) <i class="glyphicon glyphicon-arrow-right"></i> {{$data['get_city_to']->city_name }} ({{$data['get_city_to']->city_code}})</h2>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3 text-right">
                                            ...
                                            <div>
                                                ...
                                                @if (Auth::check())
                                                    @if($return_d != '')
                                                     <a href="{{url('flight-list-return')}}?to={{$from}}&from={{$to}}&departure_date={{$departure_date}}&id_flight_to={{$id_flight_to}}&return_date={{$return_date}}&flight_type={{$flight_type}}&fly_class={{$fly_class}}&person={{$person}}" class="btn btn-primary">Choose</a>
                                                    @else
