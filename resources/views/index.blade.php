                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="departure_date" id="departure" value="{{ $dateNow }}" class="form-control" placeholder="Choose Departure Date">
                                    </div>
                                    <div class="form-group">
                                        <div class="radio">
                                    ...
                                    <div class="form-group" name="flight_type" id="return" style="display: none;">
                                        ...
                                        <input type="date" id="return_date" name="return_date" class="form-control" placeholder="Choose Return Date">
                                    </div>
                                </div>
                                <div class="col-sm-4">
