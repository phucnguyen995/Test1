@extends('master')
@section('title', 'FLight List Return')
@section('content')
    <main>
        <div class="container">
            <section>
                ...
                <h2>Các chuyến bay lượt về: {{$data['get_city_from']->city_name }} ({{$data['get_city_from']->city_code}}) <i class="glyphicon glyphicon-arrow-right"></i> {{$data['get_city_to']->city_name }} ({{$data['get_city_to']->city_code}})</h2>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3 text-right">
                                            ...
                                            <div>
                                               @if(Auth::check())
                                                    <a href="{{url('flight-detail-return')}}?from={{$from}}&to={{$to}}&departure_date={{$departure_date}}&id_flight_return={{$key->id}}&return_date={{$return_date}}&flight_type={{$flight_type}}&fly_class={{$fly_class}}&person={{$person}}&id_flight_to={{$id_flight_to}}" class="btn btn-link">See Detail</a>
                                                    ...
                                                    <form method="POST" action="{{url('flight-book')}}">
                                                      ...
                                                      <input type="hidden" name="flight_return" value="{{  $key->id }}">
